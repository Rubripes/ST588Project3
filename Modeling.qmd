...
Next, we'll create the tuning grid and specify number of each of tree_depth and cost_complexity values to tune to, as well as what metrics to collect for evaluation of models.
```{r}
...
Then, we'll plot the `tree_fits` metrics
